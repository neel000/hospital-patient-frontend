...
const DoctorDetails = (props) => {
  ...
  function appoimentSubmit() {
    ...
    formData.append("patient_familly", 1)
    ...
    if (mounted) {
      ...
      if (props.user !== false) {
        ...
        AxiosFunction('get', `v1/api/familly/`, {}, true).then(resp => {
          console.log("Familly-->>>",resp)
          setFamilly({list:resp.bknd_data.data})
        })
      }
                            ...
                            <div className="profile-head">
                              ...
                              <div className="row">
                                <div className="col-md- col-sm-4 col-xs-12 dct_pic">
                                  <img src={i.photo ? 'http://178.128.106.131:8000' + i.photo : ''} className="img-responsive" />
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      {console.log('Familly Temp', familly)}
                      <select  class="form-control" 
                      onClick={(e)=>setFormFun({type:'fm', id:e.target.value})}
                      >

                          {familly.list.map((i,id)=>(
